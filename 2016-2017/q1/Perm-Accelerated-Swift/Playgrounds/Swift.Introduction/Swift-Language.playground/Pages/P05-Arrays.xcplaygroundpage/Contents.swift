...
*/
var responsibilities = ["Wake Up", "Wash the dishes", "Milk the cows"]

responsibilities.append("Churn butter")
responsibilities.append("Call the cows")

var currentTask : Int = 0

print(responsibilities[currentTask])
