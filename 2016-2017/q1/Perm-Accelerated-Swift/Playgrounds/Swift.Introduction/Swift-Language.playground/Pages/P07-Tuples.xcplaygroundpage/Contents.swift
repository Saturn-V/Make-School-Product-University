...
var xDiff = Double(endCoord.x) - startCoord.x
var yDiff = Double(endCoord.y) - startCoord.y
var length = sqrt(xDiff * xDiff + yDiff * yDiff)

var usa: (amount: Double, currency: String) = (1.00, "usd")
var ca: (amount: Double, currency: String) = (usa.amount * 1.29, "cad")
var aus: (amount: Double, currency: String) = (usa.amount * 1.36, "aud")
//print(")
